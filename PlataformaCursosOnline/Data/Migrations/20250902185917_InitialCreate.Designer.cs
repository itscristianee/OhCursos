...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlataformaCursosOnline.Models.Categorias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PlataformaCursosOnline.Models.Cursos", b =>
                {
                    b.HasOne("PlataformaCursosOnline.Models.Categorias", "Categoria")
                        .WithMany("Cursos")
                        .HasForeignKey("CategoriaFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlataformaCursosOnline.Models.Utilizadores", "Formador")
                        .WithMany("CursosCriados")
                        .HasForeignKey("FormadorFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlataformaCursosOnline.Models.Inscricoes", b =>
                {
                    b.HasOne("PlataformaCursosOnline.Models.Cursos", "Curso")
                        .WithMany("Inscricoes")
                        .HasForeignKey("CursoFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlataformaCursosOnline.Models.Utilizadores", "Utilizador")
                        .WithMany("Inscricoes")
